...
from db.queries import detalle_juego, obtener_topicos_resenas, score_propio
...
def mostrar_detalle(conn):
    ...
    if not juego_df.empty:
        ...
        with col_der:
            ...
            # Usamos columnas pequeñas para que los datos resalten
            ...
            with st.spinner("✨ Consultando a los expertos..."):
                ...
                st.markdown(f"##Sinopsis Directa\n{gancho}")
                st.write("") # Espacio
                st.info(f"##Veredicto de la Comunidad\n\n{analisis}")